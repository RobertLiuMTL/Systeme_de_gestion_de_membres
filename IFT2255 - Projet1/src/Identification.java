...
public class Identification {
	...
	/**
	 * Fonction d'identification qui vérifie si le Membre est inscrit
	 * Vérifie également si le Client est suspendu ou non.
	 * 
	 * Prend les listes de la Base de données, ainsi que le numéro
	 * entré à l'aide de l'interface utilisateur.
	 * 
	 * @param data : base de données
	 * @param numero : Numéro de client à 9 chiffre
	...
	/**
	 * Une deuxième version de l'identificateur (Pourrait peut-être servir aux
	 * CU qui nécessitent l'authentification : ex - s'inscrire à un cours)
	 * Vérifie si le Membre est inscrit au #GYM, s'il n'est pas suspendu.
	 * 
	 * Retourne un résultat sous forme de booléenne plutôt que String.
	 * @param data : base de données
	 * @param numero : numéro à 9 chiffres
