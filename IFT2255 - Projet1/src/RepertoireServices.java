...
/**
 * À FAIRE Le répertoire de Services n'a pas encore été implémenté.
 * 
 * 
...
public class RepertoireServices {
	...
	/**
	 * Constructeur du répertoire des Services Reçoit en argument la Base de données
	 * (contrôleur) Peut retourner à la vue à partir de la Base de Données
	 * 
	 * @param data
	 */
